...
namespace Task_Selenium
{
    public class Test_Selenium
    {
        ...
        public void Setup()
        {
            ...
            //Scenario_1_7
            Thread.Sleep(100);
            if (Ñorrectness_Ñheck(By.CssSelector(" .sweet-alert"), webDriver) == true)
                webDriver.Navigate().GoToUrl("https://image.shutterstock.com/image-vector/flat-round-check-mark-green-260nw-652023034.jpg");
